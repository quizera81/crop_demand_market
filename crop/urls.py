...
urlpatterns = [
    ...
    #     path("crop/<slug:slug>", views.crop_show, name="crop.show"),
    ...
    #     path("season/<slug:slug>", views.season_show, name="season.show"),
    ...
    #     path("category/<slug:slug>", views.category_show, name="category.show"),
]
